    ...
    <div class="row">
        <div class="col-12 mt-3">
            <div class="card">
                ...
                <div class="card-body">
                    <form id="filterForm" action="{{ route('sales.filter') }}" method="GET">
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-3">
                                <label for="kantin_id">Pilih kantin:</label>
                                <select name="kantin_id" id="kantin_id" class="form-control select2">
                                    <option value="">Semua</option>
